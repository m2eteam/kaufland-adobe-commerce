define([
    ...
    window.KauflandListingProductSettings = Class.create(Common, {

        // ---------------------------------------

        initialize: function () {
            jQuery.validator.addMethod('Kaufland-validate-kaufland-template-switcher', function (value, $element) {
        ...
        observeTemplate: function (id, add, edit, specify) {
            ...
            $(id).observe('change', function () {
                if (id == 'template_selling_format_id') {
                    KauflandListingProductSettingsObj.checkSellingFormatMessages();
                }
                KauflandListingProductSettingsObj.hideEmptyOption(this);
            });
            if ($(id).value) {
                $(id).simulate('change');
            }
        ...
        checkSellingFormatMessages: function () {
            ...
            var storefrontId = $('storefront_id').value;
        ...
        newShippingTemplateCallback: function () {
            ...
            KauflandListingProductSettingsObj.reload(Kaufland.url.get('getShippingTemplates'), 'template_shipping_id');
        ...
        newReturnPolicyTemplateCallback: function () {
            ...
            KauflandListingProductSettingsObj.reload(Kaufland.url.get('getReturnPolicyTemplates'), 'template_return_policy_id');
        ...
        newSellingFormatTemplateCallback: function () {
            ...
            KauflandListingProductSettingsObj.reload(Kaufland.url.get('getSellingFormatTemplates'), 'template_selling_format_id');
        ...
        newSynchronizationTemplateCallback: function () {
            ...
            KauflandListingProductSettingsObj.reload(Kaufland.url.get('getSynchronizationTemplates'), 'template_synchronization_id');
