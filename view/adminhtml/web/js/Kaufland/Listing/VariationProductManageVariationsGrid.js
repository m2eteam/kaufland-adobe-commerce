define([
    ...
    window.KauflandListingVariationProductManageVariationsGrid = Class.create(Grid, {
        ...
        initialize: function ($super, gridId) {
            ...
            jQuery.validator.addMethod('Kaufland-upc', function (value, el) {
            ...
            }, Kaufland.translator.translate('Please enter valid UPC'));

            jQuery.validator.addMethod('Kaufland-ean', function (value, el) {
            ...
            }, Kaufland.translator.translate('Please enter valid EAN'));

            jQuery.validator.addMethod('Kaufland-isbn', function (value, el) {
                ...
                return false;
            }, Kaufland.translator.translate('Please enter valid ISBN'));
        ...
        confirmVariationIdentifiers: function (editBtn, variationId) {
            ...
            new Ajax.Request(Kaufland.url.get('kaufland_listing_variation_product_manage/setIdentifiers'), {
                method: 'post',
                parameters: data,
        ...
        isValid: function (form) {
            var upc = form.down('.Kaufland-upc'),
                    ean = form.down('.Kaufland-ean'),
                    isbn = form.down('.Kaufland-isbn'),
                    mpn = form.down('.Kaufland-mpn');
