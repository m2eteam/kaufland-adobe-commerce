define([
    'Kaufland/Grid',
    'Kaufland/Kaufland/Listing/AllItems/Action',
    'Kaufland/Listing/Action/Processor'
], function () {

    window.KauflandListingAllItemsGrid = Class.create(Grid, {
        ...
        prepareActions: function () {
            ...
            this.actionHandler = new KauflandListingAllItemsAction(actionProcessor);
        ...
        validateItemsForMassAction: function () {
            if (this.getSelectedProductsString() === '' || this.getSelectedProductsArray().length === 0) {
                this.alert(Kaufland.translator.translate('please_select_the_products'));
