            ...
            uiTabs.forEach(item => {
                ...
                if (isFormValid) {
                    ...
                    if (form.length) {
                        ...
                        const result = this.submitTab(Kaufland.url.get(elementId), formData);
            ...
            jQuery(modalDialogMessage).confirm({
                ...
                actions: {
                    confirm: function () {
                        ...
                        new Ajax.Request(Kaufland.url.get('settings_interface/restoreRememberedChoices'), {
                            method: 'get',
                            asynchronous: true,
                            onSuccess: function (transport) {
                                ...
                                self.messageObj.addSuccess($t('Help Blocks have been restored.'));
                            }
                        });
                    }
                },
