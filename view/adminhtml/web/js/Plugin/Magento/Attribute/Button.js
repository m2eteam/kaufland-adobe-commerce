define([
    ...
    window.MagentoAttributeButton = Class.create({
        ...
        _template: "<fieldset class='fieldset admin__fieldset  Kaufland-fieldset'>" +
        ...
        init: function (element, callback) {
            ...
            var popup = jQuery(popupElement).modal({
                title: Kaufland.translator.translate(
                ...
                buttons: [{
                    ...
                    text: Kaufland.translator.translate('Insert'),
        ...
        _renderMagentoAttributes: function (containerElement) {
            ...
            var select = new Element('select',
                    _.extend({
                        ...
                        class: 'select admin__control-select Kaufland-custom-attribute-can-be-created',
            ...
            containerElement.innerHTML = _.template(this._template)({
                id: 'magento-attribute-select-' + this._id,
                title: Kaufland.translator.translate('Attribute'),
