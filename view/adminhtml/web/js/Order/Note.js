define([
    ...
    window.OrderNote = Class.create(Grid, {
        ...
        openAddNotePopup: function (orderId) {
            new Ajax.Request(Kaufland.url.get('order/getNotePopupHtml'), {
                method: 'post',
                parameters: {
                    order_id: orderId
                },
        ...
        openPopup: function (content) {
            ...
            var popup = jQuery(modalDialogMessage).modal({
                title: Kaufland.translator.translate('Custom Note'),
        ...
        saveNote: function () {
            ...
            new Ajax.Request(Kaufland.url.get('order/saveNote'), {
                method: 'post',
        ...
        deleteNote: function (noteId) {
            if (!confirm(Kaufland.translator.translate('Are you sure?'))) {
                return;
            }

            new Ajax.Request(Kaufland.url.get('order/deleteNote'), {
                method: 'post',
                parameters: {
                    note_id: noteId
                },
