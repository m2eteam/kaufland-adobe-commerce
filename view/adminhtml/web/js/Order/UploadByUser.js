define([
    ...
    window.UploadByUser = Class.create(Common, {
        ...
        openPopup: function () {
            new Ajax.Request(Kaufland.url.get('order_uploadByUser/getPopupHtml'), {
                method: 'post',
                parameters: {},
                onSuccess: function (transport) {
                    ...
                    var popup = jQuery(modalBlock).modal({
                        title: Kaufland.translator.translate('Order Reimport'),
                        type: 'popup',
        ...
        resetUpload: function (accountId) {
            new Ajax.Request(Kaufland.url.get('order_uploadByUser/reset'), {
                method: 'post',
                parameters: {
                ...
                onSuccess: function (transport) {
                    ...
                    if (json.result) {
                        this.messageManager.addSuccess(Kaufland.translator.translate('Order importing is canceled.'));
                    }
                }.bind(this)
            });
        },
        ...
        configureUpload: function (accountId) {
            ...
            new Ajax.Request(Kaufland.url.get('order_uploadByUser/configure'), {
                method: 'post',
                parameters: {
                    account_id: accountId,
                ...
                onSuccess: function (transport) {
                    ...
                    if (json.result) {
                        this.messageManager.addSuccess(Kaufland.translator.translate('Order importing in progress.'));
                    }
                }.bind(this)
            });
        },
