define([
    ...
    window.AdvancedFilterUpdating = Class.create({
        ...
        sendForm: function (successCallback, validationFailCallback) {
            new Ajax.Request(Kaufland.url.get('listing_product_advanced_filter/update'), {
                method: 'post',
                parameters: {
        ...
        delete: function () {
            ...
            confirm({
                actions: {
                    confirm: function() {
                        new Ajax.Request(Kaufland.url.get('listing_product_advanced_filter/delete'), {
                            method: 'post',
                            parameters: {
