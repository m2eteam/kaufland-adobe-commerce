define([
    ...
    window.Common = Class.create({
        ...
        initCommonValidators: function () {
            var self = this;
            jQuery.validator.addMethod('Kaufland-required-when-visible', function (value, el) {
            ...
            jQuery.validator.addMethod('Kaufland-required-when-visible-and-enabled', function (value, el) {
            ...
            jQuery.validator.addMethod('Kaufland-validation-float', function (value, element) {
            ...
            }, Kaufland.translator.translate('Invalid input data. Decimal value required. Example 12.05'));

            jQuery.validator.addMethod('Kaufland-store-switcher-validation', function (value, element) {
                if (!element.visible()) {
                    return true;
                }
                ...
                return true;
            }, Kaufland.translator.translate('You should select Store View'));

            jQuery.validator.addMethod('Kaufland-validate-email', function (value, el) {
                this.error = Validation.get('validate-email').error;
                return Validation.get('validate-email').test(value, el);
            }, Kaufland.translator.translate('Email is not valid.'));
        },
        ...
        saveClick: function (url, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                url = Kaufland.url.get('formSubmit', {'back': base64_encode('list')});
            }
            this.submitForm(url);
        },
        ...
        saveAndEditClick: function (url, tabsId, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                ...
                url = Kaufland.url.get('formSubmit', {'back': base64_encode('edit' + tabsUrl)});
            }
            this.submitForm(url);
        },
        ...
        duplicateClick: function ($headId, chapter_when_duplicate_text) {
            ...
            Kaufland.url.add({'formSubmit': Kaufland.url.get('formSubmitNew')});
            ...
            $$('.Kaufland_duplicate_button').each(function (o) {
                o.hide();
            });
            $$('.Kaufland_delete_button').each(function (o) {
                o.hide();
            });
        ...
        setValidationCheckRepetitionValue: function (idInput, textError, model, dataField, idField, idValue, filterField, filterValue) {
            ...
            jQuery.validator.addMethod(
                    idInput, function (value) {
                        ...
                        new Ajax.Request(Kaufland.url.get('general/validationCheckRepetitionValue'), {
                            method: 'post',
                            asynchronous: false,
                            parameters: {
                                model: model,
