define([
    ...
    window.SettingsLogClearing = Class.create(Common, {
        ...
        initialize: function () {
            jQuery.validator.addMethod('Kaufland-logs-clearing-interval', function (value, el) {

                if (jQuery.validator.methods['Kaufland-required-when-visible'](null, el)) {
                    return true;
                }
                ...
                return true;
            }, Kaufland.translator.translate('logs_clearing_keep_for_days_validation_message'));
        },
            ...
            self.confirm({
                actions: {
                    confirm: function () {
                        ...
                        SettingsObj.submitTab(Kaufland.url.get('formSubmit', {
                            'task': 'clear_all',
                            'log': log
                        }), formData);
                    },
