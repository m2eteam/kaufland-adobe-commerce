...
/**
 * Class \M2E\Kaufland\Block\Adminhtml\Magento\Product\Grid
 */
abstract class Grid extends \M2E\Kaufland\Block\Adminhtml\Magento\Grid\AbstractGrid
{
...
CSS
    ...
    public function getMassactionBlockHtml()
    {
        ...
        $advancedFilterBlock = $this
            ->getLayout()
            ->createBlock(\M2E\Kaufland\Block\Adminhtml\Listing\Product\Rule::class);
...
JS
    ...
    {
        /** @var \M2E\Kaufland\Model\Magento\Product\Rule $rule */
