...
namespace M2E\Kaufland\Block\Adminhtml\Magento\Product\Rule;
...
class ViewState
{
    ...
    private \M2E\Kaufland\Helper\Data\Session $session;
    private bool $isShowRuleBlock = false;

    public function __construct(string $viewKey, \M2E\Kaufland\Helper\Data\Session $session)
    {
