...
namespace M2E\Kaufland\Block\Adminhtml\Magento\Product\Rule\Chooser;

use M2E\Kaufland\Block\Adminhtml\Magento\Grid\AbstractGrid;

/**
 * Class \M2E\Kaufland\Block\Adminhtml\Magento\Product\Rule\Chooser\Sku
 */
class Sku extends AbstractGrid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'chooser_name',
            ['header' => __('Product Name'), 'name' => 'chooser_name', 'index' => 'name']
        );
