...
namespace M2E\Kaufland\Block\Adminhtml\AdvancedFilter\Renderer;

class Updating extends \M2E\Kaufland\Block\Adminhtml\AdvancedFilter\AbstractRenderer
{
    private int $updatedEntityId;
    private string $viewStateKey;
    private \M2E\Kaufland\Model\Magento\Product\Rule $ruleModel;
    private \M2E\Kaufland\Model\AdvancedFilter\Repository $repository;

    public function __construct(
        int $updatedEntityId,
        string $viewStateKey,
        \M2E\Kaufland\Model\Magento\Product\Rule $ruleModel,
        \M2E\Kaufland\Model\AdvancedFilter\Repository $repository,
    ...
    public function renderJs(
        \M2E\Kaufland\Block\Adminhtml\Magento\Renderer\JsRenderer $js,
        \M2E\Kaufland\Block\Adminhtml\Magento\Renderer\JsUrlRenderer $jsUrl,
        \M2E\Kaufland\Block\Adminhtml\Magento\Renderer\JsTranslatorRenderer $jsTranslator
    ): void {
        $jsUrl->add(
        ...
        $js->addRequireJs(
            ['af' => 'Kaufland/AdvancedFilter/Updating'],
            <<<JS
...
JS
    ...
    public function renderHtml(string $searchBtnHtml, string $resetBtnHtml): string
    {
        $ruleBlock = $this->getLayout()
                          ->createBlock(\M2E\Kaufland\Block\Adminhtml\Magento\Product\Rule::class)
                          ->setData(['rule_model' => $this->ruleModel]);

        /** @var \M2E\Kaufland\Block\Adminhtml\Magento\Button $btn */
        $updateFilterBtn = $this->getLayout()->createBlock(\M2E\Kaufland\Block\Adminhtml\Magento\Button::class);
        ...
        /** @var \M2E\Kaufland\Block\Adminhtml\Magento\Button $backBtn */
        $backBtn = $this->getLayout()->createBlock(\M2E\Kaufland\Block\Adminhtml\Magento\Button::class);
        $backBtn->setData([
            'label' => __('Back'),
            'class' => 'action-default scalable action-primary',
        ...
        /** @var \M2E\Kaufland\Block\Adminhtml\Magento\Button $deleteBtn */
        $deleteBtn = $this->getLayout()->createBlock(\M2E\Kaufland\Block\Adminhtml\Magento\Button::class);
        $deleteBtn->setData([
            'label' => __('Delete'),
