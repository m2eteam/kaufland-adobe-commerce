        ...
        $form->addField(
            ...
            [
                'content' => __(
                    ...
                    <p>If the automatic relisting doesn\'t work (usually because of the errors returned from %channel_title),
...
HTML
        ...
        $ruleModel = $this->productRuleFactory
            ->create(TemplateSynchronization::RELIST_ADVANCED_RULES_PREFIX);
