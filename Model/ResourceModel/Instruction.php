...
class Instruction extends \M2E\Kaufland\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\Kaufland\Helper\Module\Database\Tables::TABLE_NAME_PRODUCT_INSTRUCTION, 'id');
    }
}
