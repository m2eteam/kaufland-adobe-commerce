...
use M2E\Kaufland\Model\Magento\Product\Image;
use M2E\Kaufland\Model\Magento\Product\Inventory\Factory;
...
class Product
{
    ...
    /** @var \M2E\Kaufland\Model\Magento\Product\Variation */
    ...
    protected $isGroupedProductMode = \M2E\Kaufland\Model\Product::GROUPED_PRODUCT_MODE_OPTIONS;
     ...
     *
     * @return \M2E\Kaufland\Model\Magento\Product | \M2E\Kaufland\Model\Magento\Product\Cache
    ...
    public function loadProduct($productId = null, $storeId = null)
    {
        ...
        if ($productId <= 0) {
            throw new \M2E\Kaufland\Model\Exception('The Product ID is not set.');
        }
    ...
    public function getProduct(): \Magento\Catalog\Model\Product
    {
        ...
        throw new \M2E\Kaufland\Model\Exception('Load instance first');
    }
    ...
    {
        if (\M2E\Kaufland\Model\Product::GROUPED_PRODUCT_MODE_SET == $this->isGroupedProductMode) {
    ...
    protected function getGroupedQty($lifeMode = false)
    {
        ...
        foreach ($this->getTypeInstance()->getAssociatedProducts($this->getProduct()) as $childProduct) {
            ...
            if (\M2E\Kaufland\Model\Product::GROUPED_PRODUCT_MODE_OPTIONS == $this->isGroupedProductMode) {
                $value += $qty;
                continue;
            }
