...
class Variation extends \M2E\Kaufland\Model\AbstractModel
{
     ...
     * @return $this
     */
    public function setMagentoProduct(\M2E\Kaufland\Model\Magento\Product $magentoProduct)
    {
    ...
    protected function getConfigurableVariationsTypeStandard()
    {
        ...
        foreach ($productTypeInstance->getUsedProducts($product, null) as $childProduct) {
            ...
            foreach ($attributes as $attributeCode => $attributeLabel) {
                $attributeValue = $this->ourMagentoProductFactory->create()
