...
class Configurator
{
    ...
    private \M2E\Kaufland\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory;

    public function __construct(
        \M2E\Kaufland\Model\Magento\Tax\Rule\BuilderFactory $taxRuleFactory,
    ...
    public function getShippingTaxClassId()
    {
        ...
        if (
            ...
            return \M2E\Kaufland\Model\Magento\Product::TAX_CLASS_ID_NONE;
        }
