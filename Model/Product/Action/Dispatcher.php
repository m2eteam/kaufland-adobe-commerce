...
class Dispatcher
{
    ...
    /** @var \M2E\Kaufland\Model\Product\Action\ConfiguratorFactory */
    ...
    /**
     * @param \M2E\Kaufland\Model\Product\Action\PackageCollection $packageCollection
     *
     * @return Package[][][]
     */
    private function groupProductsByAccountAndStorefront(
        \M2E\Kaufland\Model\Product\Action\PackageCollection $packageCollection
    ): array {
        $packages = [];
