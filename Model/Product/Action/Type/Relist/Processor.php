...
class Processor extends \M2E\Kaufland\Model\Product\Action\AbstractProcessor
{
    ...
    protected function makeCall(): \M2E\Core\Model\Connector\Response
    {
        ...
        $command = new \M2E\Kaufland\Model\Channel\Connector\Product\RelistCommand(
    ...
    {
        return \M2E\Kaufland\Model\Product\Action\DefinitionsCollection::ACTION_UNIT_RELIST;
    }
