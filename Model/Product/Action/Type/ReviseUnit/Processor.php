...
class Processor extends \M2E\Kaufland\Model\Product\Action\AbstractProcessor
{
    ...
    private \M2E\Kaufland\Model\Product\Action\Type\ReviseUnit\LoggerFactory $loggerFactory;

    public function __construct(
        ValidatorFactory $actionValidatorFactory,
        RequestFactory $requestFactory,
        ResponseFactory $responseFactory,
        \M2E\Kaufland\Model\Product\Action\Type\ReviseUnit\LoggerFactory $loggerFactory,
    ...
    protected function makeCall(): \M2E\Core\Model\Connector\Response
    {
        ...
        $command = new \M2E\Kaufland\Model\Channel\Connector\Product\ReviseCommand(
    ...
    {
        return \M2E\Kaufland\Model\Product\Action\DefinitionsCollection::ACTION_UNIT_REVISE;
    }
