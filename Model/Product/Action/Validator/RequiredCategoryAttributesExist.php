...
class RequiredCategoryAttributesExist implements \M2E\Kaufland\Model\Product\Action\Validator\ValidatorInterface
{
    ...
    public function validate(\M2E\Kaufland\Model\Product $product): ?ValidatorMessage
    {
        ...
        if (!empty($notValidAttributesLabels)) {
            return new ValidatorMessage(
                ...
                \M2E\Kaufland\Model\Tag\ValidatorIssues::ERROR_REQUIRED_ATTRIBUTE_MISSING
            );
        }
