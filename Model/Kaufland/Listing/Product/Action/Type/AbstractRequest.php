...
abstract class AbstractRequest extends \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\AbstractRequest
{
    /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\AbstractDataBuilder[] */
    ...
    private function getDataBuilder(
        string $nick
    ): \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\AbstractDataBuilder {
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Qty $dataBuilder */
        $dataBuilder = $this->getDataBuilder(DataBuilder\Qty::NICK);
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Price $dataBuilder */
        $dataBuilder = $this->getDataBuilder(DataBuilder\Price::NICK);
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Title $dataBuilder */
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Description $dataBuilder */
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Images $dataBuilder */
    ...
    {
        /** @var \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\DataBuilder\Attributes $dataBuilder */
        $dataBuilder = $this->getDataBuilder(DataBuilder\Attributes::NICK);
