...
class ProcessorAsyncFactory
{
    ...
    private \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\Async\Factory $asyncActionFactory;
    private \M2E\Kaufland\Model\Product\LockManager $lockManager;
    private \M2E\Kaufland\Model\Processing\Runner $processingRunner;
    private \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\Async\Processing\InitiatorFactory $initiatorFactory;
    ...
    public function __construct(
        ...
        \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\Async\Factory $asyncActionFactory,
        \M2E\Kaufland\Model\Processing\Runner $processingRunner,
        \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\Async\Processing\InitiatorFactory $initiatorFactory,
    ...
    private function createRequestData(array $data): \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\RequestData
    {
        $requestData = new \M2E\Kaufland\Model\Kaufland\Listing\Product\Action\RequestData();
