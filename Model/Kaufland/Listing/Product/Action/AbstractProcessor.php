...
abstract class AbstractProcessor
{
    ...
    private function validateListingProduct(): bool
    {
        ...
        foreach ($this->getActionValidator()->getMessages() as $messageData) {
            $this->addActionLogMessage(
                \M2E\Core\Model\Response\Message::create($messageData['text'], $messageData['type']),
            );
        }
    ...
    public function setLogBuffer(\M2E\Kaufland\Model\Kaufland\Listing\Product\Action\LogBuffer $logBuffer): void
    {
        $this->logBuffer = $logBuffer;
    }

    public function setActionLogger(\M2E\Kaufland\Model\Kaufland\Listing\Product\Action\Logger $logger): void
    {
