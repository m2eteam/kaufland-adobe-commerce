...
use M2E\Kaufland\Model\ResourceModel\AdvancedFilter as AdvancedFilterResource;

class Repository
{
    private \M2E\Kaufland\Model\ResourceModel\AdvancedFilter\CollectionFactory $collectionFactory;
    private \M2E\Kaufland\Model\AdvancedFilter $advancedFilter;

    public function __construct(
        \M2E\Kaufland\Model\ResourceModel\AdvancedFilter\CollectionFactory $collectionFactory,
    ...
    public function getAdvancedFilter(int $id): \M2E\Kaufland\Model\AdvancedFilter
    {
        ...
        if ($advancedFilter->isEmpty()) {
            throw new \M2E\Kaufland\Model\Exception\Logic(sprintf('Not found entity by id - [%d]', $id));
        }
    ...
    public function remove(\M2E\Kaufland\Model\AdvancedFilter $advancedFilter): void
    {
