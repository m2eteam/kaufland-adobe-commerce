...
namespace M2E\Kaufland\Model\Channel\Order\Receive\ItemsByCreateDate;
...
class Processor
{
    ...
    public function process(
        ...
        $command = new \M2E\Kaufland\Model\Channel\Connector\Order\Receive\ItemsByCreateDateCommand(
