...
namespace M2E\Kaufland\Model\Channel\Order\Receive\ItemsByUpdateDate;
...
class Processor
{
    ...
    public function process(
        ...
        $command = new \M2E\Kaufland\Model\Channel\Connector\Order\Receive\ItemsByUpdateDateCommand(
            $account->getServerHash(),
            $updateFrom,
            $updateTo,
        );

        /** @var \M2E\Kaufland\Model\Channel\Connector\Order\Receive\Response */
