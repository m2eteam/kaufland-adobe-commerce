...
namespace M2E\Kaufland\Model\Channel\ShippingGroup;

use M2E\Kaufland\Model\Channel\Connector\ShippingGroup\Get\Response;
...
class Processor
{
    ...
    {
        $command = new \M2E\Kaufland\Model\Channel\Connector\ShippingGroup\GetItemsCommand(
