...
namespace M2E\Kaufland\Model\Channel\Connector\ShippingGroup;
...
class GetItemsCommand implements \M2E\Core\Model\Connector\CommandInterface
{
    ...
    public function parseResponse(\M2E\Core\Model\Connector\Response $response): \M2E\Kaufland\Model\Channel\Connector\ShippingGroup\Get\Response
    {
        ...
        return new \M2E\Kaufland\Model\Channel\Connector\ShippingGroup\Get\Response(
            $shippingGroups
        );
    }
}
