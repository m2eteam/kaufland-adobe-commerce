...
namespace M2E\Kaufland\Model\Channel\Connector\Attribute;

use M2E\Kaufland\Model\Channel\Attribute\Item;
...
class GetCommand implements \M2E\Core\Model\Connector\CommandInterface
{
    ...
    public function parseResponse(\M2E\Core\Model\Connector\Response $response): \M2E\Kaufland\Model\Channel\Connector\Attribute\Get\Response
    {
        ...
        return new \M2E\Kaufland\Model\Channel\Connector\Attribute\Get\Response(
            $attributes
        );
    }
}
